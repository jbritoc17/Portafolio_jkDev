            ...
            {categories.map((category, index) => (
              <li key={index} className="flex justify-center items-center ">
                <div className="hover:scale-105 duration-1000 group relative  overflow-hidden rounded-lg">
                  <Link to={`/category/${category.name}`} className="   ">
                    <div className="">
                      <img
          ...
          {products.map((product) => (
            <li key={product.id}>
              <main className="group ">
                <div className="group-hover:shadow-lg group-hover:scale-105 duration-300 ">
                  <article className="bg-white shadow rounded overflow-hidden flex flex-col group-hover:border-sky-500 group-hover:border">
                    <div className="h-52">
                      <img
                        className="group-hover:scale-90 h-full w-full  object-contain object-center mx-auto  duration-300"
                        src={product.image}
                        alt=""
                      />
                    </div>
